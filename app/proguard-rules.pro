...
-keep class com.harmber.suadat.models.PersistQueue { *; }
-keep class com.harmber.suadat.models.PersistPlayerState { *; }
-keep class com.harmber.suadat.models.QueueData { *; }
-keep class com.harmber.suadat.models.QueueType { *; }
-keep class com.harmber.suadat.playback.queues.** { *; }
