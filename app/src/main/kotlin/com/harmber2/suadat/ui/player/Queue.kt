...
import com.harmber2.suadat.constants.QueueEditLockKey
...
import com.harmber2.suadat.ui.component.MediaMetadataListItem
import com.harmber2.suadat.ui.menu.AddToPlaylistDialog
import com.harmber2.suadat.ui.menu.PlayerMenu
import com.harmber2.suadat.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.harmber2.suadat.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.harmber2.suadat.together.TogetherSessionState.Joined).role is com.harmber2.suadat.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.harmber2.suadat.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.harmber2.suadat.together.TogetherRole.Guest
                                                                if (isGuest) {
