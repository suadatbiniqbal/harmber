...
object DiscordImageResolver {
    ...
    fun buildRpcImage(
        ...
        return when (imageType.lowercase()) {
            ...
            "appicon" -> {
                RpcImage.ExternalImage("https://media.discordapp.net/attachments/1308643062012055613/1468673074089038107/IMG_20251222_124514_899.webp?ex=6984dfe3&is=69838e63&hm=af0c79b64f9199cd8f280a7fddf99fc7d9ace4b23ec4db21400821c3f6cdadc6&=&format=webp&width=865&height=865")
            }
            "custom" -> {
