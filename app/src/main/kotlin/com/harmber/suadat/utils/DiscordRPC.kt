...
class DiscordRPC(
    ...
    companion object {
        private const val APPLICATION_ID = "1448923821640912917"
        ...
        private const val APP_ICON_URL = 
            "https://cdn.discordapp.com/attachments/1308643062012055613/1468673074089038107/IMG_20251222_124514_899.webp?ex=6984dfe3&is=69838e63&hm=af0c79b64f9199cd8f280a7fddf99fc7d9ace4b23ec4db21400821c3f6cdadc6"
    ...
    suspend fun updateSong(
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://harmber.fun"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.harmber.suadat.utils.GlobalLog.append(
