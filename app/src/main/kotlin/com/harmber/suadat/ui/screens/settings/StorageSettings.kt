...
import com.harmber.suadat.constants.MaxImageCacheSizeKey
import com.harmber.suadat.constants.MaxSongCacheSizeKey
import com.harmber.suadat.constants.SmartTrimmerKey
import com.harmber.suadat.extensions.tryOrNull
...
import com.harmber.suadat.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.harmber.suadat.utils.ArtworkStorage.clear(context)
            }
        }
    }
